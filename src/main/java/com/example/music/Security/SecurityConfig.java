...
//                                                        .requestMatchers("/api/events", "/api/events/get/**").permitAll()
//                                                        .requestMatchers("/api/merchandise", "/api/merchandise/get/**").permitAll()
//                                                        .requestMatchers("/api/track/get/**").permitAll()
//    //                                                        .requestMatchers("/**/upload", "**/update", "/**/delete").hasRole("ADMIN")
//                                                        .requestMatchers("/upload/**", "/update/**", "/delete/**").hasRole("ADMIN")
